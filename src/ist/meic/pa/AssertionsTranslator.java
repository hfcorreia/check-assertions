...
public class AssertionsTranslator implements Translator {
    ...
    private void assertionVerifier(CtClass ctClass, CtMethod ctMethod) throws NotFoundException {
        ...
        if (assertion != null && ctClass != null && !isAbstractMethod(ctMethod)) {
            try {
                ...
                auxiliarMethod.setBody(" { " + "	" + ctMethod.getReturnType().getName() + " $_ = " + ctMethod.getName() + "($$);"
                        + "	" + "if( ! ( " + assertion + " ) ) { " + "	" + "	" + "throw new java.lang.RuntimeException(\"\");"
                        + "	" + "}" + "	" + "return ($r)$_;" + " } ");
    ...
    private String getInterfaceAssert(CtClass ctClass, CtMethod ctMethod) {
        ...
        for (CtClass interf : interfaces) {
            ...
            try {
                interfMethod = interf.getMethod(ctMethod.getName(), ctMethod.getSignature());
